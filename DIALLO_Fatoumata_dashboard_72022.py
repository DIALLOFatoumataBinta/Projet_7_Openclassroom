...
app_train['Age']= (-app_train['DAYS_BIRTH']//355).astype(int)
app_train['Age'].max()
...
def main():
    ...
    if id_client == '':
        ...
        response = requests.get('http://127.0.0.1:5000/predict_target', "modelname="+modelname+"&ID_client="+id_client)
        ...
        features_importances = plot_features_importances(df, modelname)
